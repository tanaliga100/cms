    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!user) {
                    return [2 /*return*/, res.status(404).json({ message: "User ".concat(params.id, " not founds") })];
                }
                return [2 /*return*/, res.status(200).json({ message: "Success", user: user })];
            case 2:
                error_1 = _a.sent();
